                                   ...
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    // [LCDGateway] The vendor driver powered the display FPC's backlight controller
    // (I2C 0x45) here via the i2c_bus component. That plumbing lives in panel.cpp now
    // (Wire, single-threaded setup context), keeping this file free of bus ownership.
