...
// [LCDGateway] Version macros normally injected by the component build (idf_component.yml).
#define ESP_LCD_JD9365_10_1_VER_MAJOR 1
#define ESP_LCD_JD9365_10_1_VER_MINOR 0
#define ESP_LCD_JD9365_10_1_VER_PATCH 0
